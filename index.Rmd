...
election_dat30 <- readRDS("data/election_dat30.rds") %>% 
  ...
  mutate(party = case_when(
    str_detect(page_name, "\\bDEVA\\b|\\bDeva\\b")  ~ "DEVA",
    T ~ party  ))  %>% 
    filter(!(party %in% c("Diğ", "Bağ", "Mem", "ATA")))
...
Here, we show the *top targeted audiences* for each party (ranked by amount of Turkish Lira spend). Most (but not all) of these audiences are “interest” audiences, i.e. the parties targeted people interested in “Books” or “Politics”.
